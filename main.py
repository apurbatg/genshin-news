...
TOKEN = "6045575028:AAE6_jwYsattQMHhmr9SUH3vWB4ppY3EAuQ"
...
updater.dispatcher.add_handler(CommandHandler('update', send_update))
...
while True:
    ...
    send_update(None, updater.dispatcher)  # send regular updates to all users
